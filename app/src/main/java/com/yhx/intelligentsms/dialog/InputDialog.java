...
public class InputDialog extends BaseDialog {
    ...
    private TextView et_inputdialog_message;
    ...
    public void initView() {
        ...
        tv_inputdialog_title = findViewById(R.id.tv_inputdialog_title);
        et_inputdialog_message = findViewById(R.id.et_inputdialog_message);
        bt_inputdialog_cancel = findViewById(R.id.bt_inputdialog_cancel);
        bt_inputdialog_confirm = findViewById(R.id.bt_inputdialog_confirm);
    }
